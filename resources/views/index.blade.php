                        ...
                        <div class="card-body d-flex flex-column justify-content-between p-4" style="background: var(--bs-card-bg);border-style: none;border-radius: 6px;border-top-left-radius: 0px;border-top-right-radius: 0px;">
                            <div>
                                <ul class="list-unstyled me-xl-0 mb-md-5 mb-sm-5">
                                    <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded bs-icon-primary-light bs-icon me-2 mt-1" style="background: #4162a471;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg" style="font-size: 16px;color: #4562a4;">
