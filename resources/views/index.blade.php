...
<div class="w3-center pb-5 pt-5">
  ...
  <div class="card-header text-white text-center p-4 text-uppercase" style="background-color:#E64422">
  ...
  <a href="#" class="btn btn-success">Sign Up</a>
    ...
    <div class="col-sm-12 col-md-4 d-flex">
    <div class="col card mb-5">
    <div class="card-header text-white text-center p-4 text-uppercase" style="background-color:#FC7233">
